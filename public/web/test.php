<?php
  ...
  // $url=urldecode("http://www.qixin.com/search?key=%E5%8D%97%E4%BA%AC%E5%90%89%E5%B1%B1&type=enterprise&source=&isGlobal=Y");
 ...
 // for($i=2;$i<=$pageCount;$i++){
     ...
     // $res=$snoopy->results;
     // $res=json_encode($res,1);//转化数组
     // foreach($res['list'] as $k=>$v){
         // $data[]=$res['list'][$k];
     // }
 // }
  // $z =array('31231','33434','yrryty');
  // $dfg = 'qereeqeqwrs34567';
 // var_dump(bin2hex($dfg));
 class CUtf8_PY {
